...
- Treat the current `0.50` lower bound as provisional rather than empirically calibrated.
- Backtest no finishing adjustment, an unbounded confidence-shrunk adjustment, and several candidate bounds.
